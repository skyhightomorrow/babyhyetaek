...
const NATIONAL = {
  ...
  // 2026 확대(korea.kr 공식 확인 2026-07-15): 2025년 8세미만 → 2030년 13세미만, 매년 1세씩.
  //   → 2026년 = 9세 미만(0~107개월, 108개월간). 2026-04 지급분 반영, 2026-01분부터 소급.
  //   비수도권·인구감소지역 월 +2만(+지역사랑상품권 시 +1만) — 대상 지역 범위 모호해 총액 미반영, 안내만.
  childPay: {
    label: '아동수당',
    amount: WON(10),        // 월 10만
    untilMonths: 108,       // 9세 미만 = 0~107개월 (2026 확대 반영)
    monthly: true,
    nonMetroBonus: WON(2),  // 비수도권·인구감소지역 월 +2만 (대상 모호 → 안내용)
    sourceNote: 'korea.kr 2026 개편 · 월10만, 2026년 9세미만(2030 13세까지 단계적)',
  },
